...
- Table:
- File: 
- Path: E:\SureCash Work\Daily Churn Prediction 3
- Document/Presentation/Dashboard: 
- Email thread: 
- Notes (if any): 
	- Recall crossed 80%, accuracy 68%, poor precision; increasing layers did not help; training set size may be more representative
...
where 
	(churn_cat=1 and seq<=50000)
	or 
	(churn_cat=0 and seq<=50000)
order by random(); 